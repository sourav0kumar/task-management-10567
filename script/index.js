...
const htmlTaskContent=({id,title,description,type,url}) =>
    ...
    <div class='col-md-6 col-lg-4 mt-3' id=${id} key=${id}>
      <div class='card shadow-sm task__card'>
        <div class='card-header d-flex gap-2 justify-content-end task __card__header'>
        ...
        <div class="card-footer">
          <button class='btn btn-outline-primary float-right' type='button' data-bs-toggle='modal' 
